...
- (void)showWithStatus:(NSString*)string maskType:(SVProgressHUDMaskType)hudMaskType networkIndicator:(BOOL)show {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        [self setBgColorForMainView]; //Vibhooti
...
//            self.imageView.image = [UIImage imageNamed:@"SVProgressHUD.bundle/error.png"];
            self.imageView.image = [UIImage imageNamed:@"wrong.png"];
        }
        else
        {
//         self.imageView.image = [UIImage imageNamed:@"SVProgressHUD.bundle/success.png"];
            self.imageView.image = [UIImage imageNamed:@"right.png"];
        }
...
- (UIView *)hudView
{
    if(!hudView) {
        ...
        hudView.layer.cornerRadius = 10;
           ...
           hudView.backgroundColor = [UIColor colorWithWhite:0.2 alpha:0.99];
